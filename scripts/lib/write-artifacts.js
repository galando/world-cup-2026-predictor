 ...
 */
function computeCalibration(matches, predictions) {
...
/**
 * Write all 8 JSON files to public/data/.
 */
export function writeArtifacts({ matches, predictions, teams, teamsMeta, standings, bracket }) {
  ...
  console.log(`[write-artifacts] wrote 8 files to ${OUTPUT_DIR}`);
}
